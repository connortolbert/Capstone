...
Green = ((50, 70, 95), (75, 140, 140))  # This color range defines the color target
Red = ((0, 125, 155), (50, 180, 215))  # This color range defines the color target  80
Blue = ((50, 130, 70), (125, 255, 225))  # This color range defines the color target
...
if __name__ == "__main__":
    while True:
        target = colorTarget(Green) # generate a target
        print(target)
        x = target[0]
        if x is None:
